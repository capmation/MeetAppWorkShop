<template>
  <div>
    <div class="bg-dark-800/60 backdrop-blur-sm border border-white/10 rounded-2xl p-8 shadow-2xl">
      <h2 class="text-xl font-semibold text-white mb-2">Welcome back</h2>
      <p class="text-slate-400 text-sm mb-8">Sign in to start or join video meetings.</p>
